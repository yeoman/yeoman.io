...
Every legacy methods (`this.write`, `this.copy`, [etc](http://yeoman.io/generator/generator/actions.html)) have been back ported to use this new system. So updating to 0.18.0 should magically improve your generator.
