...
You can check [the full helpers API here](http://yeoman.github.io/generator/module-test_helpers.html). These methods will usually be run inside a `before` block.
