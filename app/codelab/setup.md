...
Most of your interactions with Yeoman will be through the command line. Run commands in the Terminal app if you’re on Mac, your shell in Linux, or [`cmder`](https://github.com/cmderdev/cmder) *(preferably)* / PowerShell / `cmd.exe` if you are on Windows.
